...
def mai(root):
    ...
    recruit2 = Button(
        ...
        bg="#05edFC",
        relief="raised",
        activebackground="#05F6FD",
        command=lambda: client_regis(root),
    )
...
def recruiter_regis(root):
    ...
    btn = Button(
        ...
        command=lambda: recruiter_check(root),
    )
...
def recruit_complete(root):
    ...
    btn = Button(
        ...
        bd=0,
        activebackground="#ffffff",
        command=lambda: recruiter_submit(root),
    )
    btn.place(x=320, y=500)
...
def client_regis(root):
    ...
    btn = Button(
        ...
        bd=0,
        activebackground="#ffffff",
        command=lambda: client_check(root),
    )
    btn.place(x=320, y=500)
...
def client_complete(root):
    ...
    btn = Button(
        ...
        bd=0,
        activebackground="#ffffff",
        command=lambda: client_submit(root),
    )
